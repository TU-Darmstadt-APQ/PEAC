...
ax_ellipse_left_hist_diff = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=3, ny=2))
ax_ellipse_left_hist_sum = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=2, ny=3))
ax_ellipse_left = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=2, ny=2))

ax_ellipse_right_hist_diff = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=7, ny=2))
ax_ellipse_right_hist_sum = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=6, ny=3))
ax_ellipse_right = fig_4.add_axes(div.get_position(), axes_locator=div.new_locator(nx=6, ny=2))
...
########## Insets ################
fig_4.canvas.draw()
ax_ellipse_left_width_in, ax_ellipse_left_height_in = hf.get_ax_size_inches(ax_ellipse_left, fig_4)
