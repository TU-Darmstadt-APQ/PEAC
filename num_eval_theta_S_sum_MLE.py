...
##################################
data_theta_scan = np.load('num_data/num_fits_res_theta_S_sum_MLE.npz')
...
results_MLE_theta_scan          = data_theta_scan['results_MLE']
...
A0_hist_fits_theta_scan = (
    results_MLE_theta_scan[:, :, 0] + results_MLE_theta_scan[:, :, 3]) / 2

# sum signal fit results
A_sum_hist_fits_theta_scan      = results_MLE_theta_scan[:, :, 6]
sigma_sum_hist_fits_theta_scan  = results_MLE_theta_scan[:, :, 7]
mu_sum_hist_fits_theta_scan     = results_MLE_theta_scan[:, :, 8]
...
A_diff_hist_fits_theta_scan     = results_MLE_theta_scan[:, :, 9]
sigma_diff_hist_fits_theta_scan = results_MLE_theta_scan[:, :, 10]
mu_diff_hist_fits_theta_scan    = results_MLE_theta_scan[:, :, 11]
...
# masking outliers
mask_sum = hf.find_numerical_outliers(A_sum_hist_fits_theta_scan, threshold_factor=8, mean_axis=1)
mask_diff = hf.find_numerical_outliers(A_diff_hist_fits_theta_scan, threshold_factor=8, mean_axis=1)

A_sum_hist_fits_theta_scan[mask_sum] = np.nan
A_diff_hist_fits_theta_scan[mask_diff] = np.nan
...
thetas_sum_mean_raw_theta_scan = np.nanmean(thetas_sum_theta_scan, axis=1)
thetas_sum_std_theta_scan = np.nanstd(thetas_sum_theta_scan, axis=1, ddof=1)

thetas_diff_mean_raw_theta_scan = np.nanmean(thetas_diff_theta_scan, axis=1)
thetas_diff_std_theta_scan = np.nanstd(thetas_diff_theta_scan, axis=1, ddof=1)
...
thetas_sum_mean_theta_scan, thetas_diff_mean_theta_scan = np.empty_like(
    thetas_theta_scan), np.empty_like(thetas_theta_scan)
...
np.savez_compressed('num_eval/num_eval_res_theta_S_sum_MLE.npz',
